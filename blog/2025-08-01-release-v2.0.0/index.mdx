...
1. `./scripts/deploy --steps migrate_db`
2. `python manage.py migrate_tags_config_to_meta`
3. `python manage.py reformat_configs`
4. `python manage.py assign_project_by_meta -m <meta_name>` (meta name to split runs into projects; default: `PROJECT`)
5. `python manage.py initialize_configs`
